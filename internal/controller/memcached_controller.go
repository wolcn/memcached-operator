...
import (
	...
	cachev1alpha1 "github.com/wolcn/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.wolcn.net/finalizer"
...
// +kubebuilder:rbac:groups=cache.wolcn.net,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.wolcn.net,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.wolcn.net,resources=memcacheds/finalizers,verbs=update
